<template>
  <div
    class="page-center-wrapper w-full overflow-x-hidden flex flex-col min-h-screen font-kantumruy bg-gray-50 text-gray-800"
  >
    <!-- Main Content -->
    <div class="home-content-wrapper flex-grow pt-20">
      <section class="top-products-section py-12 md:py-16">
        <div class="container mx-auto px-4 sm:px-6">
          <!-- Header -->
          <div
            class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6 mb-12"
          >
            <div class="text-center lg:text-left">
              <h1 class="text-xl text-gray-900 mb-4">{{ pageTitle }}</h1>
              <p class="text-l leading-relaxed text-gray-600 max-w-2xl">
                Discover our latest men's fashion collection featuring trendy
                styles, premium quality, and comfortable fits for every
                occasion.
              </p>
            </div>
            ...
            <div class="flex justify-center lg:justify-end">
              ...
              >
                ...
                <span
                  ...
                  class="ml-2 bg-blue-800 text-xs px-2 py-1 rounded-full"
                >
                  {{ activeFiltersCount }}
                </span>
              </button>
          ...
          <!-- Filter/Sort Bar -->
          <div
            class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 p-4 bg-white rounded-lg shadow-sm"
          >
            <div class="flex items-center space-x-4">
              ...
              >
                <span class="text-sm font-medium text-gray-700"
                  >{{ activeFiltersCount }} filters applied</span
                >
                <button
            ...
            >
              <div class="relative overflow-hidden">
                ...
                <div class="absolute top-3 left-3">
                  <span
                    class="bg-green-500 text-white text-xs px-2 py-1 rounded-full shadow-sm"
                    >IN STOCK</span
                  >
                </div>
              </div>
      ...
      >
        <div class="w-80 max-w-sm h-full bg-white flex flex-col shadow-xl">
          ...
          <div class="px-4 py-3 border-t bg-gray-50 space-y-2">
            ...
            <button
              @click="resetFilters"
              class="w-full border border-gray-300 text-gray-700 py-2 rounded-md hover:bg-gray-100"
            >
              Reset All
            </button>
          </div>
...
const fetchProducts = async () => {
  try {
    ...
    const parentSlug = route.params.parentName || "women";
    ...
    // women.vue
    const base = "/public/products/parent-category"; // remove /api
    let endpoint = childSlug
      ? `${base}/${encodeURIComponent(parentSlug)}/${encodeURIComponent(
          childSlug
        )}`
